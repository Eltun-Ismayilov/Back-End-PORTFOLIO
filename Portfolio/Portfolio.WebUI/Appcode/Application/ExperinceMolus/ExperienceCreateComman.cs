...
namespace Portfolio.WebUI.Appcode.Application.ExperinceMolus
{
    public class ExperienceCreateComman : IRequest<Experience>
    {
        ...
        public class ExperienceCreateCommanHandler : IRequestHandler<ExperienceCreateComman, Experience>
        {
            ...
            public ExperienceCreateCommanHandler(PortfolioDbContext db, IActionContextAccessor ctx, IWebHostEnvironment env) //Model.State burda yoxlamaq ucun yazilib.
            {
                this.db = db;
                this.ctx = ctx;
                this.env = env;
